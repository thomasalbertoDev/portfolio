...
export default function Navbar() {
  return (
    <div className="z-10 w-full container items-center justify-between font-mono text-sm lg:flex pb-20">
      ...
      <div className="fixed bottom-0 left-0 flex h-40 w-full items-end justify-center bg-gradient-to-t  from-black via-black lg:static lg:size-auto lg:bg-none gap-3">
        {/* Linkedin */}
        <Link
